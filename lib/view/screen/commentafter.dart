...
class commentpageafter extends StatefulWidget {
  String selected;
  commentpageafter(this.selected);
  @override
  _TestMeState createState() => _TestMeState();
}

class _TestMeState extends State<commentpageafter> {
  ...
  getAllComments() async {
    var response = await viewcommentData.postdata(widget.selected);
    print(response);
    print("=====================================");
    print(UserPhoto);
